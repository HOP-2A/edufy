            ...
            {roadmap?.learningSections.map((section, index) => {
              ...
              return (
                <div key={section.id} className="relative group">
                  {/* THE LINE: Returning to the downward logic, but stopping at the last item */}
                  ...
                  <div className="flex gap-8 relative z-10">
                    {/* The Square Node */}
                    <div className="pt-6">
                      <div className="w-[48px] h-[48px] border border-slate-300 bg-white flex items-center justify-center transition-all group-data-[state=open]:border-slate-900">
                        <span className="font-mono text-xs text-slate-400 group-data-[state=open]:text-slate-900">
                          {(index + 1).toString().padStart(2, "0")}
                        </span>
                      </div>
                    </div>

                    {/* Square Bordered Module Container */}
                    <div className="flex-1 border border-slate-400 bg-white p-1 transition-all hover:border-slate-300 group-data-[state=open]:border-slate-300 rounded-2xl">
                      <div className="border border-transparent group-data-[state=open]:border-slate-100">
                        <Accordion
                          type="single"
                          collapsible
                          ...
                          >
                            ...
                            <AccordionContent className="px-6 pb-12 pt-2 border-t border-slate-50">
                              <div className="space-y-12">
                                ...
                                <div className="h-[2px] w-124 bg-slate-200" />

                                <div
                                  className={`grid grid-cols-1 ${hasTasks ? "lg:grid-cols-2" : "grid-cols-1"} gap-12`}
                                >
                                  {/* Resources */}
                                  <div className="space-y-6">
